...
public class ScanLocalImage {
    ...
    public static ImageModerationResponse invokeFunction(String accessKeyId, String accessKeySecret, String endpoint) throws Exception {
        ...
        String filePath = "C:\\Users\\胡明飞\\Desktop\\Snipaste_2025-10-18_19-05-12.png";
        //获取文件上传token
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        String accessKeyId = "LTAI5tLVdKVPWxqcWrJUji8n";
        String accessKeySecret = "1la4RGQPuRV4iALWxzgR1ljDdWXdz3";
        // 接入区域和地址请根据实际情况修改。
